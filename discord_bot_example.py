...
# Configurações
DISCORD_BOT_TOKEN = os.getenv("DISCORD_BOT_TOKEN", "SEU_BOT_TOKEN_AQUI")
API_URL = os.getenv("API_URL", "https://seu-app.replit.app")  # Substitua pela URL do seu app
API_SECRET = os.getenv("API_SECRET_KEY", "your-secret-api-key-here")  # Mesmo valor do app.py
